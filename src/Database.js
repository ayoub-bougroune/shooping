...
export const Items = [
  ...
  },
  {
    id: 2,
    category: 'product',
    productName: 'boAt Rocker 450 Bluetooth Headphone',
    productPrice: 1499,
    description:
      'boAt Rocker 450 M is an on-ear wireless headset that has been ergonomically designed to meet the needs of music lovers.',
    isOff: false,
  ...
  },
  {
    id: 5,
    category: 'accessory',
    productName: 'boAt Rocker 255 Pro+',
    productPrice: 1499,
    description:
